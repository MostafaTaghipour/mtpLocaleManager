...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of mtpLocaleManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mostafa.taghipour@ymail.com/mtpLocaleManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mostafa.taghipour@ymail.com' => 'mostafa.taghipour@ymail.com' }
  s.source           = { :git => 'https://github.com/mostafa.taghipour@ymail.com/mtpLocaleManager.git', :tag => s.version.to_s }
